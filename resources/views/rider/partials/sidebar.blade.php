<aside class="w-72 hidden md:flex flex-col bg-[#0EA5B9] text-white min-h-screen">
    <div class="px-6 py-6 border-b border-white/20 flex items-center gap-3">
        <div class="h-12 w-12 rounded-2xl bg-white/15 flex items-center justify-center font-black text-xl">
            B
        </div>
        <div>
    ...
    class="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-700 hover:bg-slate-100 font-semibold">
        <span>Settings</span>
    </a>
